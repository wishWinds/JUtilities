...
CGContextRef JCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef JCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);


/// Get main screen's scale.
CGFloat JScreenScale(void);

/// Get main screen's size. Height is always larger than width.
CGSize JScreenSize(void);
 ...
 */
CGAffineTransform JCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
CGAffineTransform JCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode JCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *JUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect JCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale JScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize JScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth JScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight JScreenSize().height
#endif
