...
- (NSString *)stringByFlatUrl {
    NSString *flatStr = [self stringByReplacingOccurrencesOfString:@":" withString:@"-"];
    flatStr = [flatStr stringByReplacingOccurrencesOfString:@"/" withString:@"-"];
